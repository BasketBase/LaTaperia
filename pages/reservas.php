...
<html>
	<head lang="ES">
		...
		<link rel="stylesheet" type="text/css" href="/LaTaperia/css/reservas.css"></link>
	...
	<body>
		<div id="nav-main">
			...
			<a class="nav-main-e5 active">RESERVAS</a>
		...
		<div id="content">
			<div id="container">
				<span id="desc">
					<div style="font-size: 20px;color: #C30;font-weight: bold;text-align: center;">Llámanos por teléfono para reservar mesa.</div>
					<div style="margin-top: 40px">Abrimos todos los días:</div>
					<div style="margin-left: 100px; margin-top: 20px">
						Comidas: <strong>13:30 a 16:00h</strong><br/>Cenas: <strong>20:30 a 00:00h</strong><br/>
					</div>
					<div>
				...
				<span id="foto">
					<!--<img src="/LaTaperia/img/slider/1.jpg">-->
				</span>
			</div>
		</div>
	</body>
